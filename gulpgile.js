...
//============================================    
    ...
    gulp.task('js:dev', function() {
        ...
        return gulp.src('src/js/*.js')
            .pipe(plumber({ //dodaje obs³ugê b³êdów
                errorHandler: handleError
            }))
            .pipe(sourcemaps.init()) //odpalam generowanie sourcemapy
            .pipe(concat('scripts.js')) //³aczê pliki
            .pipe(s) //pobieram rozmiar plików w stramie
            .pipe(rename({suffix: '.min'})) //zmieniam nazwê
            .pipe(sourcemaps.write('.')) //tworzê sourcemapê
            .pipe(gulp.dest('dist/js')) //wszystko zapisujê w dist/js
            .pipe(browserSync.stream()) //odpalam browserSync
            .pipe(notify({ //i wypisujê komunikat
                onLast: true,
                message: function () {
...
//============================================
    gulp.task('compile:dev', function() {
        ...
        console.log(color('Kompilujê scss i ³¹czê js', 'YELLOW'));
        console.log(color('-------------------------------------------', 'YELLOW'));
    ...
    gulp.task('compile:prod', function() {
        console.log(color('-------------------------------------------', 'YELLOW'));
        console.log(color('Kompilujê scss i js', 'YELLOW'));
        console.log(color('-------------------------------------------', 'YELLOW'));
    ...
    gulp.task('dev', function() {
        ...
        console.log(color('-------------------------------------------', 'YELLOW'));
        console.log(color('Rozpoczynamy pracê milordzie (DEV)', 'YELLOW'));
        console.log(color('-------------------------------------------', 'YELLOW'));
    });
    ...
    gulp.task('prod', function() {
        ...
        console.log(color('-------------------------------------------', 'YELLOW'));
        console.log(color('Rozpoczynamy pracê milordzie (PROD)', 'YELLOW'));
        console.log(color('-------------------------------------------', 'YELLOW'));
    });
